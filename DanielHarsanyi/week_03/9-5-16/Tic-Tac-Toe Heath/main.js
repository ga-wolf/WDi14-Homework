...
var jokerWins = localStorage.joker || 0;
var heathWins = localStorage.heath || 0;
...
var addToWinnerCount = function (winner){
  if (winner === "The Joker") {
    jokerWins ++;
    localStorage.joker = jokerWins;
    $("#jokerScore").html(jokerWins);
  } else if (winner === "Heath") {
    heathWins ++;
    localStorage.heath = heathWins;
    $("#heathScore").html(heathWins);
  }
};
...
var resetScores = function (){
  jokerWins = 0;
  localStorage.joker = 0;
  $("#jokerScore").html(jokerWins);
  heathWins = 0;
  localStorage.heath = 0;
  $("#heathScore").html(heathWins);
  console.log("hey");
};
