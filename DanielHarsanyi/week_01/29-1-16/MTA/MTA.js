...
if (userGoFromLine === "N") {
  var userGoFromStation = prompt ("Please select which station you are travelling from: Times Square, 34th, 28th, 23rd, Union Square or 8th");
} else if (userGoFromLine === "L") {
  var userGoFromStation = prompt ("Please select which station you are travelling from: 8th St, 6th, Union Square, 3rd or 1st");
} else if (userGoFromLine === "6") {
  var userGoFromStation = prompt ("Please select which station you are travelling from: Grand Central, 33rd, 28th St, 23rd St, Union Square or Astor Place");
}

var userGoToLine = prompt ("Please select which line you are travelling to: N, L or 6");

if (userGoToLine === "N") {
  var userGoToStation = prompt ("Please select which station you are travelling from: Times Square, 34th, 28th, 23rd, Union Square or 8th");
} else if (userGoToLine === "L") {
  var userGoToLineStation = prompt ("Please select which station you are travelling from: 8th St, 6th, Union Square, 3rd or 1st");
} else if (userGoToLine === "6") {
  var userGoToStation = prompt ("Please select which station you are travelling from: Grand Central, 33rd, 28th St, 23rd St, Union Square or Astor Place");
}
...
if (areLinesSame === true) {
  ...
  journeyMessage += "\n";
  journeyMessage += "We hope you enjoyed using MTA CODES!"
