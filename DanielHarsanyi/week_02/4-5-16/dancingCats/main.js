...
var randomCatPosition = {
    pinkCat: function () {
        pinkCat.style.left = ((Math.random()+1)+(Math.random()+1)*600)+"px";
        pinkCat.style.top = ((Math.random()+1)+(Math.random()+1)*300)+"px";
    },
    vibratingCat: function () {
        vibratingCat.style.left = ((Math.random()+1)+(Math.random()+1)*200)+"px";
        vibratingCat.style.top = ((Math.random()+1)+(Math.random()+1)*200)+"px";
    },
    lightsaberCat: function () {
        lightsaberCat.style.left = ((Math.random()+1)+(Math.random()+1)*1000)+"px";
        lightsaberCat.style.top = ((Math.random()+1)+(Math.random()+1)*300)+"px";
    },
    beanieCat: function () {
        beanieCat.style.left = ((Math.random()+1)+(Math.random()+1)*500)+"px";
        beanieCat.style.top = ((Math.random()+1)+(Math.random()+1)*450)+"px";
    }
};
...
var changeCatToRave = function () {
    catGif.src = "assets/cat-walk2.gif";
