...
var planTrip = function(lineOn, stopOne, lineOff, stopTwo) {
  ...
  var diffLine = function(subLine) {
    ...
    if (getOnL >= getOnO) {
      forwardsOrBackwards(getOn, getOnL);
      message += "Change at Union Square to " + subLine + " ";
      forwardsOrBackwards(getOnO, getOff);
    } else {
      if (getOn > getOnL) {
