...
//1- make a squarenumber function and get the square of that number
...
//and arrays. For many of them, you will want to consult the 
...
function mixUp(stringOne, stringTwo) {
	return stringOne.slice(0,2) + stringTwo.slice(2) + " " + stringOne.slice(0,2) + stringTwo.slice(2));
}
mixUp(Shark, Attack)
...
function fixStart('babble'): 'ba**le'
// Verbing
function fixStart(s) {
  var c = s.charAt(0);
